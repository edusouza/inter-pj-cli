...
| **"Hoje" vinha do fuso da máquina.** Num servidor em UTC às 22h30 em Brasília (já o dia seguinte), `--data` com a data de amanhã em Brasília era tomada por hoje: o agendamento era descartado e o pagamento saía um dia antes. | "Hoje" é o dia do calendário do banco, UTC−3, sem horário de verão desde 2019. Ele vale para o agendamento, a conferência de datas passadas e os períodos padrão. O Pix Automático, que tinha um "hoje" próprio, e o aviso do cancelamento depois das 22h passaram a segui-lo depois da revisão, quando os guias foram escritos. | [#127](https://github.com/edusouza/inter-pj-cli/pull/127), [#133](https://github.com/edusouza/inter-pj-cli/pull/133) |
