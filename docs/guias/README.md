...
| [Cobranças Pix](cobrancas-pix.md) | criar uma cobrança imediata (`pix cob`) com o txid que torna segura a repetição, alterar e remover, uma cobrança paga com os seus Pix, conferir uma criação de resultado incerto e as cobranças de um período |
