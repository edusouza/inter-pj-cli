...
| [Pix Automático](pix-automatico.md) | criar uma recorrência, a autorização das cobranças de um contrato, pelas opções ou por um arquivo, conferir uma criação de resultado incerto, as recorrências de um período, uma recorrência aprovada, alterar o primeiro pagamento e cancelar |
