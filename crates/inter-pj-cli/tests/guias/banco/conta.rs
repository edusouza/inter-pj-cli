//! The account (`/banking/v2`): the balance and the statements, from June
//! to September 2026 (`extrato.json`, as the enriched statement sends it).
//! The balance of a day is the opening balance plus the statement up to it.
...
use super::{parametros, requisicao};
