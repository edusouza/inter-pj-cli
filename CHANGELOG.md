...
- Guias de uso em `docs/guias`, um assunto por guia. O de saldo e extrato: o saldo e o de um dia, o extrato de um período e o de mais de 90 dias, o extrato completo com as páginas, os filtros e os detalhes, as planilhas e o PDF. O de Pix: o envio por chave, copia e cola ou dados bancários, o agendamento, o resumo e a confirmação, `--simular`, o limite e a aprovação, a repetição segura depois de uma resposta perdida e a consulta do Pix enviado. Os testes executam cada exemplo como uma sessão de terminal, contra uma simulação da API com a conta de uma empresa fictícia, e conferem que o comando imprime o que o guia mostra, então um guia desatualizado quebra o CI (#57).
